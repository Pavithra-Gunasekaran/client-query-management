...
def load_data_from_csv(csv_filepath=r'C:\Users\Sasikumar M\OneDrive\Documents\synthetic_client_queries.csv'):
    """
    ...
    try:
        ...
        conn.commit()
        print(f"Successfully inserted {cursor.rowcount} records into the 'queries' table.")
